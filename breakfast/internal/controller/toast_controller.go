...
// ToastReconciler reconciles a Toast object
type ToastReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=breakfast.newredo.com,resources=toasts,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=breakfast.newredo.com,resources=toasts/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=breakfast.newredo.com,resources=toasts/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the Toast object against the actual cluster state, and then
...
func (r *ToastReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&breakfastv1.Toast{}).
		Complete(r)
}
